...
class EventTestRepository : EventRemoteRepository {
    override fun getWhenAfter(requestJson: RequestEventJson, date: Date): Single<ResultEvent> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun getAll(requestJson: RequestEventJson): Single<ResultEvent> {
